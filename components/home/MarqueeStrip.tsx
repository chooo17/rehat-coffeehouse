const MARQUEE_TEXT =
  'SPECIALTY COFFEE ❖ REHAT COFFEEHOUSE ❖ SAMPANG EAST JAVA ❖ GOOD VIBES ❖ HANDCRAFTED DRINKS ❖ OPEN DAILY ❖ '

export function MarqueeStrip() {
  return (
    <div
      className="bg-brand-black text-brand-yellow py-2.5 overflow-hidden whitespace-nowrap select-none"
      aria-label="Specialty Coffee · Rehat Coffeehouse · Sampang East Java · Good Vibes · Handcrafted Drinks · Open Daily"
    >
