...
export function PreorderFrame({ src }: { src: string }) {
  ...
  return (
    // position:fixed + inset:0 mengikuti visual viewport secara native,
    // lebih reliable di Safari mobile daripada unit vh/dvh/svh — yang semua
    // gagal update dengan benar karena scroll terjadi di dalam iframe,
    // bukan di halaman luar.
